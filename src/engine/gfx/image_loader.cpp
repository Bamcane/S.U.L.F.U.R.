...
static int PngliteIncompatibility(png_structp pPNGStruct, png_infop pPNGInfo)
{
	...
	default:
#ifdef CONF_DEBUG
		dbg_msg("png", "color type %d unsupported by pnglite", ColorType);
#endif
	...
	default:
#ifdef CONF_DEBUG
		dbg_msg("png", "bit depth %d unsupported by pnglite", BitDepth);
#endif
	...
	{
#ifdef CONF_DEBUG
		dbg_msg("png", "interlace type %d unsupported by pnglite", InterlaceType);
#endif
	...
	{
#ifdef CONF_DEBUG
		dbg_msg("png", "non-default compression type unsupported by pnglite");
#endif
	...
	{
#ifdef CONF_DEBUG
		dbg_msg("png", "non-default filter type unsupported by pnglite");
#endif
